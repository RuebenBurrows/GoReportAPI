    ...
    $("#button2").on('click', function () {
        ...
        $.getJSON('http://movie-quotes-2.herokuapp.com/api/v1/quotes/', function (data, xhr) {
            ...
            $.each(data, function (key, val) {
                                    //Fill list with all values from the API

                                    items.push('<span class="name">' + val.film + '</span><br><br><span class="addr">' + "<i>''" + val.content + "''</i>" +
                                        '</span><br><br><span class="addr">' + " <b>told by </b>" + val.character + 
                                        '</span> <br><span class="addr">' + " <b>Year </b>" + val.year + '</span><br><span class="city">' + 
                                        "<b> Played By </B>" + val.actor + '</span><br><br>');
